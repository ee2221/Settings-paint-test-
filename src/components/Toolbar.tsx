...
import { Box, Circle, Triangle, Cylinder, Cone, Cherry as Sphere, Plus, Move, RotateCw, Scale, Edit, MousePointer, ChevronDown, Lightbulb, Sun, Zap } from 'lucide-react';
...
const Toolbar: React.FC = () => {
  ...
  const handleObjectSelect = (shape: typeof basicShapes[0]) => {
    startObjectPlacement({
    ...
    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-[#1a1a1a] rounded-xl shadow-2xl shadow-black/20 p-3 border border-white/5 z-10">
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          {/* Object Menu */}
          {showObjectMenu && (
            <div className="absolute left-full ml-2 top-0 bg-[#2a2a2a] border border-white/10 rounded-lg shadow-lg z-20 min-w-64">
              {/* Header */}
